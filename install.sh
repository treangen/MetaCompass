...
cmd="wget --no-check-certificate https://obj.umiacs.umd.edu/metacompass-treangen/markers.tar.gz -P ./src"
echo $cmd
$cmd
...
cmd="wget --no-check-certificate https://obj.umiacs.umd.edu/metacompass-treangen/refseq.tar.gz"
echo $cmd
$cmd
